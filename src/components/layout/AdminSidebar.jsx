...
const AdminSidebar = ({ isOpen, adminData, onToggle, isMobile }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { title: 'الاشتراكات', href: '/dashboard/admin/payments/subscriptions', icon: FileText }
      ]
    },
    {
  ...
  return (
    <div className={`fixed right-0 top-0 h-screen bg-white border-l border-gray-200 shadow-lg transition-all duration-300 z-50 flex flex-col ${
      isOpen ? 'w-64' : 'w-20'
    } ${
