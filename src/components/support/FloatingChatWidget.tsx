        ...
        <div className="fixed bottom-6 left-6 z-[9999]">
          <div className="relative">
            ...
            <Button
              ...
              className="relative w-16 h-16 text-white bg-gradient-to-r from-green-500 to-emerald-600 rounded-full shadow-2xl transition-all duration-300 hover:from-green-600 hover:to-emerald-700 hover:shadow-3xl hover:scale-110 border-2 border-white"
            ...
            {/* تلميح عند التمرير */}
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-900 text-white text-sm rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              الدعم الفني
            </div>
          </div>
        </div>
