...
const STEP_TITLES = {
  ...
  [STEPS.EDUCATION]: 'التعليم',
  [STEPS.MEDICAL]: 'السجل الطبي',
  [STEPS.SPORTS]: 'المعلومات الرياضية',
  [STEPS.SKILLS]: 'المهارات',
  [STEPS.OBJECTIVES]: 'الأهداف',
  [STEPS.MEDIA]: 'الوسائط',
  [STEPS.CONTRACTS]: 'العقود'
};
...
export default function ClubPlayerProfile({ params }: { params: { playerId: string } }) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="p-8 text-center bg-white rounded-lg shadow-md">
          ...
          <Button onClick={() => router.push('/dashboard/club/players')} className="text-white bg-blue-600 hover:bg-blue-700">
