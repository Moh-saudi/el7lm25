    ...
    <div className="text-center py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          مرحباً بك في منصة ولي الأمر
        </h1>
        <p className="text-xl text-gray-600 mb-8">
          منصة متكاملة لمتابعة تقدم أبنائك الرياضي
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
            <span className="text-gray-700">متابعة تقدم الأبناء</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
          ...
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
            <span className="text-gray-700">التواصل مع المدربين والأكاديميات</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
            <span className="text-gray-700">متابعة الجداول والأنشطة</span>
          </div>
        </div>
