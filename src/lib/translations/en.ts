...
const en = {
  ...
  dashboard: {
    player: {
      search: {
        title: "Search for Clubs and Opportunities",
        subtitle: "Discover the best clubs, agents, academies, and trainers",
        searchPlaceholder: "Search for clubs, agents, academies, trainers...",
        ...
        defaultDescriptions: {
          club: "Professional Sports Club",
          agent: "Licensed Player Agent",
          academy: "Talent Development Academy",
          trainer: "Certified Professional Trainer"
        },
        defaultSpecializations: {
          football: "Football",
          playerAgent: "Player Agent",
          academy: "Talent Development",
          physicalTraining: "Physical Training"
        },
        services: {
          playerTraining: "Player Training",
        ...
        mockEntities: {
          alahly: {
            ...
            description: "One of the largest and most prestigious Egyptian and Arab clubs",
            achievements: {
          ...
          starsAgency: {
            ...
            description: "FIFA-licensed player representation agency",
          ...
          faisalAcademy: {
            ...
            description: "Sports talent development academy",
            specialization: "Talent Development",
            achievements: {
              bestAcademy: "Best Academy",
              certified: "Certified"
            },
          ...
          ahmedExpert: {
            ...
            description: "Certified professional physical trainer",
            specialization: "Physical Training",
            achievements: {
              certified: "Certified",
              internationalCertification: "International Certification"
          ...
          zamalek: {
            ...
            description: "One of the most prestigious Egyptian and Arab clubs",
            achievements: {
              afcon: "African Cup of Nations",
              egyptianLeague: "Egyptian League"
            }
    ...
    'dashboard.player.search': {
      ...
      'subtitle': 'Search for clubs, agents, academies, and trainers',
      'searchPlaceholder': 'Search by name, type, or location...',
      'noResults': {
        'title': 'No Results Found',
        'description': 'Try changing your search criteria or reset filters',
        'resetFilters': 'Reset Filters'
      },
      'loadingMore': 'Loading...',
      'loadMore': 'Load More',
      ...
      'defaultNames': {
        ...
        'scout': 'Talent Scout',
        'academy': 'Sports Academy',
        'sponsor': 'Sports Sponsor',
        'trainer': 'Sports Trainer'
      },
      'defaultDescriptions': {
        'club': 'Professional sports club offering high-quality training and sports services',
        'agent': 'Professional sports agent helping players develop their sports careers',
        'scout': 'Professional talent scout searching for talented players',
        'academy': 'Sports academy specialized in developing young talents',
        'sponsor': 'Sports sponsor supporting clubs and players',
        'trainer': 'Professional sports trainer specialized in skill development'
      },
      'defaultSpecializations': {
        'football': 'Football',
      ...
      'services': {
        ...
        'youthPrograms': 'Youth Programs',
        'officialCompetitions': 'Official Competitions',
        'talentScouting': 'Talent Scouting',
      ...
      'mockEntities': {
        'alahly': {
          ...
          'description': 'One of the largest and oldest Egyptian and Arab clubs',
          'achievements': {
        ...
        'zamalek': {
          ...
          'description': 'One of the oldest Egyptian and Arab clubs',
          'achievements': {
            'afcon': 'Africa Cup of Nations',
            'egyptianLeague': 'Egyptian League'
          }
  ...
  footer: {
    ...
    branches: "Branches",
    followUs: "Follow Us",
    madeWithLove: "Made with love in",
    egypt: "Egypt",
  ...
  admin: {
    footer: {
      ...
      contact: "Contact Us",
      privacy: "Privacy Policy",
      companyName: "El7hm el7hm",
      copyright: "© {{year}} El7hm el7hm",
      logoAlt: "El7hm el7hm Logo",
      facebook: "Facebook",
      instagram: "Instagram",
      linkedin: "LinkedIn",
      tiktok: "TikTok"
